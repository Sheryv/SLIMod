...
Spawn_Limits section can be reloaded with command `slimod reload`. To kill all mobs around player use
command `slimod kill <all|passive|hostile|entity>` e.g. `slimod kill all`
...
#Range: 0.01 ~ 5.0
defaultCreatureSpawnProbabilityMultiplier = 3.0
